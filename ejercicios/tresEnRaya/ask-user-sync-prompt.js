    ...
    function prompt(ask, value, opts) {
        ...
        while (true) {
            ...
            if (
                ...
                str = str.slice(0, insert) + "á" + str.slice(insert);
                insert++;
            } else if (character === 130) {
                str = str.slice(0, insert) + "é" + str.slice(insert);
                insert++;
            } else if (character === 161) {
                str = str.slice(0, insert) + "í" + str.slice(insert);
                insert++;
            } else if (character === 162) {
                str = str.slice(0, insert) + "ó" + str.slice(insert);
                insert++;
            } else if (character === 163) {
                str = str.slice(0, insert) + "ú" + str.slice(insert);
                insert++;
                ...
                str = str.slice(0, insert) + "ü" + str.slice(insert);
                insert++;
            } else if (character === 154) {
                str = str.slice(0, insert) + "Ü" + str.slice(insert);
                insert++;
            } */ else if (character === 164) {
                str = str.slice(0, insert) + "ñ" + str.slice(insert);
                insert++;
            } else if (character === 165) {
                str = str.slice(0, insert) + "Ñ" + str.slice(insert);
                insert++;
            } else {
